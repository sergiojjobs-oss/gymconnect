...
public class DataSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        crearEntrenador("Ana",     "Martínez",  "ana.martinez@gymconnect.es",      "Barcelona",
            ...
            29.0, 4.9, 94, true, 4,
            List.of("Yoga", "Pilates", "Pérdida de grasa", "Nutrición deportiva"),
        ...
        crearEntrenador("Jorge",   "López",     "jorge.lopez@gymconnect.es",       "Sevilla",
            ...
            49.0, 4.7, 61, false, 7,
            List.of("Fuerza y potencia", "Crossfit", "Musculación / Hipertrofia"),
        ...
        crearEntrenador("Laura",   "Sánchez",   "laura.sanchez@gymconnect.es",     "Valencia",
            ...
            55.0, 5.0, 47, true, 6,
            List.of("Nutrición deportiva", "Pérdida de grasa", "Musculación / Hipertrofia"),
        ...
        crearEntrenador("Marcos",  "Fernández", "marcos.fernandez@gymconnect.es",  "Bilbao",
            ...
            35.0, 4.6, 39, false, 3,
            List.of("Fuerza y potencia", "Musculación / Hipertrofia"),
        ...
        crearEntrenador("Sofía",   "Morales",   "sofia.morales@gymconnect.es",     "Málaga",
            ...
            25.0, 4.8, 83, false, 5,
            List.of("Yoga", "Flexibilidad y movilidad", "Pérdida de grasa"),
        ...
        crearEntrenador("Rubén",   "Torres",    "ruben.torres@gymconnect.es",      "Madrid",
            ...
            60.0, 4.5, 55, true, 8,
            List.of("Crossfit", "Fuerza y potencia", "Preparación física deportiva"),
        ...
        crearEntrenador("Iván",    "Romero",    "ivan.romero@gymconnect.es",       "Alicante",
            ...
            20.0, 4.3, 28, false, 2,
            List.of("Entrenamiento online", "Pérdida de grasa", "Musculación / Hipertrofia"),
